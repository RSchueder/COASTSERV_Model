...
if [ ! -f "d:\projects\COASTSERV_Model\out\data\chl_2012-01-01_12-00-00_2012-01-30_12-00-00.nc" ]; then
   while (( ! -f "d:\projects\COASTSERV_Model\out\data\chl_2012-01-01_12-00-00_2012-01-30_12-00-00.nc" ))
   do
...
if [ ! -f "d:\projects\COASTSERV_Model\out\data\chl_2012-01-31_12-00-00_2012-02-29_12-00-00.nc" ]; then
   while (( ! -f "d:\projects\COASTSERV_Model\out\data\chl_2012-01-31_12-00-00_2012-02-29_12-00-00.nc" ))
   do
       echo "ERROR: download failed on server end, retrying..."
       echo "giving the server a break..."
       sleep 10s
...
if [ ! -f "d:\projects\COASTSERV_Model\out\data\o2_2012-01-01_12-00-00_2012-01-30_12-00-00.nc" ]; then
   while (( ! -f "d:\projects\COASTSERV_Model\out\data\o2_2012-01-01_12-00-00_2012-01-30_12-00-00.nc" ))
   do
       echo "ERROR: download failed on server end, retrying..."
       echo "giving the server a break..."
       sleep 10s
...
if [ ! -f "d:\projects\COASTSERV_Model\out\data\o2_2012-01-31_12-00-00_2012-02-29_12-00-00.nc" ]; then
   while (( ! -f "d:\projects\COASTSERV_Model\out\data\o2_2012-01-31_12-00-00_2012-02-29_12-00-00.nc" ))
   do
       echo "ERROR: download failed on server end, retrying..."
       echo "giving the server a break..."
       sleep 10s
...
if [ ! -f "d:\projects\COASTSERV_Model\out\data\no3_2012-01-01_12-00-00_2012-01-30_12-00-00.nc" ]; then
...
if [ ! -f "d:\projects\COASTSERV_Model\out\data\no3_2012-01-31_12-00-00_2012-02-29_12-00-00.nc" ]; then
...
if [ ! -f "d:\projects\COASTSERV_Model\out\data\po4_2012-01-01_12-00-00_2012-01-30_12-00-00.nc" ]; then
   while (( ! -f "d:\projects\COASTSERV_Model\out\data\po4_2012-01-01_12-00-00_2012-01-30_12-00-00.nc" ))
   do
       echo "ERROR: download failed on server end, retrying..."
       echo "giving the server a break..."
       sleep 10s
...
if [ ! -f "d:\projects\COASTSERV_Model\out\data\po4_2012-01-31_12-00-00_2012-02-29_12-00-00.nc" ]; then
   while (( ! -f "d:\projects\COASTSERV_Model\out\data\po4_2012-01-31_12-00-00_2012-02-29_12-00-00.nc" ))
   do
       echo "ERROR: download failed on server end, retrying..."
       echo "giving the server a break..."
       sleep 10s
...
if [ ! -f "d:\projects\COASTSERV_Model\out\data\si_2012-01-01_12-00-00_2012-01-30_12-00-00.nc" ]; then
   while (( ! -f "d:\projects\COASTSERV_Model\out\data\si_2012-01-01_12-00-00_2012-01-30_12-00-00.nc" ))
   do
       echo "ERROR: download failed on server end, retrying..."
       echo "giving the server a break..."
       sleep 10s
...
if [ ! -f "d:\projects\COASTSERV_Model\out\data\si_2012-01-31_12-00-00_2012-02-29_12-00-00.nc" ]; then
   while (( ! -f "d:\projects\COASTSERV_Model\out\data\si_2012-01-31_12-00-00_2012-02-29_12-00-00.nc" ))
   do
       echo "ERROR: download failed on server end, retrying..."
       echo "giving the server a break..."
       sleep 10s
