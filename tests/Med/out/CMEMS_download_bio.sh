...
if [ ! -f "D:\projects\COASTSERV_Model\tests\Med\out\data\chl_2017-05-15_12-00-00_2017-06-13_12-00-00.nc" ]; then
   while (( ! -f "D:\projects\COASTSERV_Model\tests\Med\out\data\chl_2017-05-15_12-00-00_2017-06-13_12-00-00.nc" ))
   do
...
if [ ! -f "D:\projects\COASTSERV_Model\tests\Med\out\data\chl_2017-06-14_12-00-00_2017-07-13_12-00-00.nc" ]; then
   while (( ! -f "D:\projects\COASTSERV_Model\tests\Med\out\data\chl_2017-06-14_12-00-00_2017-07-13_12-00-00.nc" ))
   do
       echo "ERROR: download failed on server end, retrying..."
       echo "giving the server a break..."
       sleep 10s
...
if [ ! -f "D:\projects\COASTSERV_Model\tests\Med\out\data\chl_2017-07-14_12-00-00_2017-08-12_12-00-00.nc" ]; then
   while (( ! -f "D:\projects\COASTSERV_Model\tests\Med\out\data\chl_2017-07-14_12-00-00_2017-08-12_12-00-00.nc" ))
   do
       echo "ERROR: download failed on server end, retrying..."
       echo "giving the server a break..."
       sleep 10s
...
if [ ! -f "D:\projects\COASTSERV_Model\tests\Med\out\data\chl_2017-08-13_12-00-00_2017-09-11_12-00-00.nc" ]; then
   while (( ! -f "D:\projects\COASTSERV_Model\tests\Med\out\data\chl_2017-08-13_12-00-00_2017-09-11_12-00-00.nc" ))
   do
       echo "ERROR: download failed on server end, retrying..."
       echo "giving the server a break..."
       sleep 10s
...
if [ ! -f "D:\projects\COASTSERV_Model\tests\Med\out\data\chl_2017-09-12_12-00-00_2017-10-11_12-00-00.nc" ]; then
   while (( ! -f "D:\projects\COASTSERV_Model\tests\Med\out\data\chl_2017-09-12_12-00-00_2017-10-11_12-00-00.nc" ))
   do
       echo "ERROR: download failed on server end, retrying..."
       echo "giving the server a break..."
       sleep 10s
...
if [ ! -f "D:\projects\COASTSERV_Model\tests\Med\out\data\o2_2017-05-15_12-00-00_2017-06-13_12-00-00.nc" ]; then
   while (( ! -f "D:\projects\COASTSERV_Model\tests\Med\out\data\o2_2017-05-15_12-00-00_2017-06-13_12-00-00.nc" ))
   do
       echo "ERROR: download failed on server end, retrying..."
       echo "giving the server a break..."
       sleep 10s
...
if [ ! -f "D:\projects\COASTSERV_Model\tests\Med\out\data\o2_2017-06-14_12-00-00_2017-07-13_12-00-00.nc" ]; then
   while (( ! -f "D:\projects\COASTSERV_Model\tests\Med\out\data\o2_2017-06-14_12-00-00_2017-07-13_12-00-00.nc" ))
   do
       echo "ERROR: download failed on server end, retrying..."
       echo "giving the server a break..."
       sleep 10s
...
if [ ! -f "D:\projects\COASTSERV_Model\tests\Med\out\data\o2_2017-07-14_12-00-00_2017-08-12_12-00-00.nc" ]; then
   while (( ! -f "D:\projects\COASTSERV_Model\tests\Med\out\data\o2_2017-07-14_12-00-00_2017-08-12_12-00-00.nc" ))
   do
       echo "ERROR: download failed on server end, retrying..."
       echo "giving the server a break..."
       sleep 10s
...
if [ ! -f "D:\projects\COASTSERV_Model\tests\Med\out\data\o2_2017-08-13_12-00-00_2017-09-11_12-00-00.nc" ]; then
   while (( ! -f "D:\projects\COASTSERV_Model\tests\Med\out\data\o2_2017-08-13_12-00-00_2017-09-11_12-00-00.nc" ))
   do
       echo "ERROR: download failed on server end, retrying..."
       echo "giving the server a break..."
       sleep 10s
...
if [ ! -f "D:\projects\COASTSERV_Model\tests\Med\out\data\o2_2017-09-12_12-00-00_2017-10-11_12-00-00.nc" ]; then
   while (( ! -f "D:\projects\COASTSERV_Model\tests\Med\out\data\o2_2017-09-12_12-00-00_2017-10-11_12-00-00.nc" ))
   do
       echo "ERROR: download failed on server end, retrying..."
       echo "giving the server a break..."
       sleep 10s
...
if [ ! -f "D:\projects\COASTSERV_Model\tests\Med\out\data\no3_2017-05-15_12-00-00_2017-06-13_12-00-00.nc" ]; then
   while (( ! -f "D:\projects\COASTSERV_Model\tests\Med\out\data\no3_2017-05-15_12-00-00_2017-06-13_12-00-00.nc" ))
   do
       echo "ERROR: download failed on server end, retrying..."
       echo "giving the server a break..."
       sleep 10s
...
if [ ! -f "D:\projects\COASTSERV_Model\tests\Med\out\data\no3_2017-06-14_12-00-00_2017-07-13_12-00-00.nc" ]; then
...
if [ ! -f "D:\projects\COASTSERV_Model\tests\Med\out\data\no3_2017-07-14_12-00-00_2017-08-12_12-00-00.nc" ]; then
...
if [ ! -f "D:\projects\COASTSERV_Model\tests\Med\out\data\no3_2017-08-13_12-00-00_2017-09-11_12-00-00.nc" ]; then
...
if [ ! -f "D:\projects\COASTSERV_Model\tests\Med\out\data\no3_2017-09-12_12-00-00_2017-10-11_12-00-00.nc" ]; then
...
if [ ! -f "D:\projects\COASTSERV_Model\tests\Med\out\data\po4_2017-05-15_12-00-00_2017-06-13_12-00-00.nc" ]; then
   while (( ! -f "D:\projects\COASTSERV_Model\tests\Med\out\data\po4_2017-05-15_12-00-00_2017-06-13_12-00-00.nc" ))
   do
       echo "ERROR: download failed on server end, retrying..."
       echo "giving the server a break..."
       sleep 10s
...
if [ ! -f "D:\projects\COASTSERV_Model\tests\Med\out\data\po4_2017-06-14_12-00-00_2017-07-13_12-00-00.nc" ]; then
   while (( ! -f "D:\projects\COASTSERV_Model\tests\Med\out\data\po4_2017-06-14_12-00-00_2017-07-13_12-00-00.nc" ))
   do
       echo "ERROR: download failed on server end, retrying..."
       echo "giving the server a break..."
       sleep 10s
...
if [ ! -f "D:\projects\COASTSERV_Model\tests\Med\out\data\po4_2017-07-14_12-00-00_2017-08-12_12-00-00.nc" ]; then
   while (( ! -f "D:\projects\COASTSERV_Model\tests\Med\out\data\po4_2017-07-14_12-00-00_2017-08-12_12-00-00.nc" ))
   do
       echo "ERROR: download failed on server end, retrying..."
       echo "giving the server a break..."
       sleep 10s
...
if [ ! -f "D:\projects\COASTSERV_Model\tests\Med\out\data\po4_2017-08-13_12-00-00_2017-09-11_12-00-00.nc" ]; then
   while (( ! -f "D:\projects\COASTSERV_Model\tests\Med\out\data\po4_2017-08-13_12-00-00_2017-09-11_12-00-00.nc" ))
   do
       echo "ERROR: download failed on server end, retrying..."
       echo "giving the server a break..."
       sleep 10s
...
if [ ! -f "D:\projects\COASTSERV_Model\tests\Med\out\data\po4_2017-09-12_12-00-00_2017-10-11_12-00-00.nc" ]; then
   while (( ! -f "D:\projects\COASTSERV_Model\tests\Med\out\data\po4_2017-09-12_12-00-00_2017-10-11_12-00-00.nc" ))
   do
       echo "ERROR: download failed on server end, retrying..."
       echo "giving the server a break..."
       sleep 10s
...
if [ ! -f "D:\projects\COASTSERV_Model\tests\Med\out\data\si_2017-05-15_12-00-00_2017-06-13_12-00-00.nc" ]; then
   while (( ! -f "D:\projects\COASTSERV_Model\tests\Med\out\data\si_2017-05-15_12-00-00_2017-06-13_12-00-00.nc" ))
   do
       echo "ERROR: download failed on server end, retrying..."
       echo "giving the server a break..."
       sleep 10s
...
if [ ! -f "D:\projects\COASTSERV_Model\tests\Med\out\data\si_2017-06-14_12-00-00_2017-07-13_12-00-00.nc" ]; then
   while (( ! -f "D:\projects\COASTSERV_Model\tests\Med\out\data\si_2017-06-14_12-00-00_2017-07-13_12-00-00.nc" ))
   do
       echo "ERROR: download failed on server end, retrying..."
       echo "giving the server a break..."
       sleep 10s
...
if [ ! -f "D:\projects\COASTSERV_Model\tests\Med\out\data\si_2017-07-14_12-00-00_2017-08-12_12-00-00.nc" ]; then
   while (( ! -f "D:\projects\COASTSERV_Model\tests\Med\out\data\si_2017-07-14_12-00-00_2017-08-12_12-00-00.nc" ))
   do
       echo "ERROR: download failed on server end, retrying..."
       echo "giving the server a break..."
       sleep 10s
...
if [ ! -f "D:\projects\COASTSERV_Model\tests\Med\out\data\si_2017-08-13_12-00-00_2017-09-11_12-00-00.nc" ]; then
   while (( ! -f "D:\projects\COASTSERV_Model\tests\Med\out\data\si_2017-08-13_12-00-00_2017-09-11_12-00-00.nc" ))
   do
       echo "ERROR: download failed on server end, retrying..."
       echo "giving the server a break..."
       sleep 10s
...
if [ ! -f "D:\projects\COASTSERV_Model\tests\Med\out\data\si_2017-09-12_12-00-00_2017-10-11_12-00-00.nc" ]; then
   while (( ! -f "D:\projects\COASTSERV_Model\tests\Med\out\data\si_2017-09-12_12-00-00_2017-10-11_12-00-00.nc" ))
   do
       echo "ERROR: download failed on server end, retrying..."
       echo "giving the server a break..."
       sleep 10s
