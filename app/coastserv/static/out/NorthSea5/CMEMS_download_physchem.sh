...
if [ ! -f "d:\projects\COASTSERV_Model\app\coastserv\static\out\NorthSea5\data\thetao_2011-12-22_12-00-00_2011-12-28_12-00-00.nc" ]; then
   while (( ! -f "d:\projects\COASTSERV_Model\app\coastserv\static\out\NorthSea5\data\thetao_2011-12-22_12-00-00_2011-12-28_12-00-00.nc" ))
   do
...
if [ ! -f "d:\projects\COASTSERV_Model\app\coastserv\static\out\NorthSea5\data\thetao_2011-12-29_12-00-00_2012-01-04_12-00-00.nc" ]; then
   while (( ! -f "d:\projects\COASTSERV_Model\app\coastserv\static\out\NorthSea5\data\thetao_2011-12-29_12-00-00_2012-01-04_12-00-00.nc" ))
   do
       echo "ERROR: download failed on server end, retrying..."
       echo "giving the server a break..."
       sleep 10s
...
if [ ! -f "d:\projects\COASTSERV_Model\app\coastserv\static\out\NorthSea5\data\bottomT_2011-12-22_12-00-00_2011-12-28_12-00-00.nc" ]; then
   while (( ! -f "d:\projects\COASTSERV_Model\app\coastserv\static\out\NorthSea5\data\bottomT_2011-12-22_12-00-00_2011-12-28_12-00-00.nc" ))
   do
       echo "ERROR: download failed on server end, retrying..."
       echo "giving the server a break..."
       sleep 10s
...
if [ ! -f "d:\projects\COASTSERV_Model\app\coastserv\static\out\NorthSea5\data\bottomT_2011-12-29_12-00-00_2012-01-04_12-00-00.nc" ]; then
   while (( ! -f "d:\projects\COASTSERV_Model\app\coastserv\static\out\NorthSea5\data\bottomT_2011-12-29_12-00-00_2012-01-04_12-00-00.nc" ))
   do
       echo "ERROR: download failed on server end, retrying..."
       echo "giving the server a break..."
       sleep 10s
...
if [ ! -f "d:\projects\COASTSERV_Model\app\coastserv\static\out\NorthSea5\data\so_2011-12-22_12-00-00_2011-12-28_12-00-00.nc" ]; then
   while (( ! -f "d:\projects\COASTSERV_Model\app\coastserv\static\out\NorthSea5\data\so_2011-12-22_12-00-00_2011-12-28_12-00-00.nc" ))
   do
       echo "ERROR: download failed on server end, retrying..."
       echo "giving the server a break..."
       sleep 10s
...
if [ ! -f "d:\projects\COASTSERV_Model\app\coastserv\static\out\NorthSea5\data\so_2011-12-29_12-00-00_2012-01-04_12-00-00.nc" ]; then
   while (( ! -f "d:\projects\COASTSERV_Model\app\coastserv\static\out\NorthSea5\data\so_2011-12-29_12-00-00_2012-01-04_12-00-00.nc" ))
   do
       echo "ERROR: download failed on server end, retrying..."
       echo "giving the server a break..."
       sleep 10s
...
if [ ! -f "d:\projects\COASTSERV_Model\app\coastserv\static\out\NorthSea5\data\zos_2011-12-22_12-00-00_2011-12-28_12-00-00.nc" ]; then
   while (( ! -f "d:\projects\COASTSERV_Model\app\coastserv\static\out\NorthSea5\data\zos_2011-12-22_12-00-00_2011-12-28_12-00-00.nc" ))
   do
       echo "ERROR: download failed on server end, retrying..."
       echo "giving the server a break..."
       sleep 10s
...
if [ ! -f "d:\projects\COASTSERV_Model\app\coastserv\static\out\NorthSea5\data\zos_2011-12-29_12-00-00_2012-01-04_12-00-00.nc" ]; then
   while (( ! -f "d:\projects\COASTSERV_Model\app\coastserv\static\out\NorthSea5\data\zos_2011-12-29_12-00-00_2012-01-04_12-00-00.nc" ))
   do
       echo "ERROR: download failed on server end, retrying..."
       echo "giving the server a break..."
       sleep 10s
...
if [ ! -f "d:\projects\COASTSERV_Model\app\coastserv\static\out\NorthSea5\data\uo_2011-12-22_12-00-00_2011-12-28_12-00-00.nc" ]; then
   while (( ! -f "d:\projects\COASTSERV_Model\app\coastserv\static\out\NorthSea5\data\uo_2011-12-22_12-00-00_2011-12-28_12-00-00.nc" ))
   do
       echo "ERROR: download failed on server end, retrying..."
       echo "giving the server a break..."
       sleep 10s
...
if [ ! -f "d:\projects\COASTSERV_Model\app\coastserv\static\out\NorthSea5\data\uo_2011-12-29_12-00-00_2012-01-04_12-00-00.nc" ]; then
   while (( ! -f "d:\projects\COASTSERV_Model\app\coastserv\static\out\NorthSea5\data\uo_2011-12-29_12-00-00_2012-01-04_12-00-00.nc" ))
   do
       echo "ERROR: download failed on server end, retrying..."
       echo "giving the server a break..."
       sleep 10s
...
if [ ! -f "d:\projects\COASTSERV_Model\app\coastserv\static\out\NorthSea5\data\vo_2011-12-22_12-00-00_2011-12-28_12-00-00.nc" ]; then
   while (( ! -f "d:\projects\COASTSERV_Model\app\coastserv\static\out\NorthSea5\data\vo_2011-12-22_12-00-00_2011-12-28_12-00-00.nc" ))
   do
       echo "ERROR: download failed on server end, retrying..."
       echo "giving the server a break..."
       sleep 10s
...
if [ ! -f "d:\projects\COASTSERV_Model\app\coastserv\static\out\NorthSea5\data\vo_2011-12-29_12-00-00_2012-01-04_12-00-00.nc" ]; then
   while (( ! -f "d:\projects\COASTSERV_Model\app\coastserv\static\out\NorthSea5\data\vo_2011-12-29_12-00-00_2012-01-04_12-00-00.nc" ))
   do
       echo "ERROR: download failed on server end, retrying..."
       echo "giving the server a break..."
       sleep 10s
